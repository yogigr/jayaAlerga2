@extends('master')
@section('title', 'Ketegori ' . $category->name)
@section('breadcrumb')
		...
		<div class="panel panel-default sidebar-menu">
			...
			<div class="panel-body">
				<ul class="nav nav-pills flex-column text-sm category-menu">
					...
					<li class="nav-item">
						<a href="{{ url('category/'.$cat->slug) }}" class="nav-link d-flex align-items-center justify-content-between {{ $category->id == $cat->id ? 'active' : '' }}">
							<span>{{ $cat->name }}</span>
							<span class="badge badge-secondary">
								{{ $cat->products()->count() }}
							</span>
